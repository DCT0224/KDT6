...
okt = Okt()
text = '마임에 꽂힌 칼한자루 보다 마음에 꽂힌 꽃한송이가 더 아파서 잠이 오지 않는다.'
...
# -----------------------------------------------------------
text = '''나랏말이 중국과 달라 한자와 서로 통하지 아니하므로,우매한 백성들이 말하고 싶은 것이 있어도 마침내 제 뜻을 잘 표현하지 못하는 사람이 많다.내 이를 딱하게 여기어 새로 스물여덟 자를 만들었으니,사람들로 하여금 쉬 익히어 날마다 ㅆ는 데 편하게 할 뿐이다.'''
