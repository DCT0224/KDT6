...
def hun_preprocessing_text(text):
    ...
    with open(r'C:\Users\KDP-14\Desktop\VSCode\KDT6\Torch_NLP\cgi-bin\vocab_hun.pkl', 'rb') as f:
        vocab = pickle.load(f)     

    # 불용어 경로
    STOPWORDS = r'C:\Users\KDP-14\Desktop\VSCode\KDT6\Torch_NLP\cgi-bin\stopwords-ko_hun.txt'
